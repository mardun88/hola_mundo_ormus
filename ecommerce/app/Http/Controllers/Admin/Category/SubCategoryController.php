...
class SubCategoryController extends Controller
{
    ...
    public function storesubcat(Request $resquest)
    {
        ...
        $data = array();
        $data['category_id'] = $resquest->category_id;
        $data['subcategory_name'] = $resquest->subcategory_name;
        DB::table('subcategories')->insert($data);
        $notification=array(
            'messege'=>'Sub-Category Inserted Successfuly',
            'alert-type'=>'success'
        );
    ...
    public function UpdateSubcat(Request $request, $id)
    {
        ...
        $notification=array(
                'messege'=>'Sub Category   Successfully',
                'alert-type'=>'success'
                 );
