                      ...
                      <div class="col-lg-4">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                              ...
                              <input class="form-control" type="text" name="video_link" name="Video link" >
                            </div>
                        </div><!-- col-4 -->
                        <div class="col-lg-4">
                            <div class="form-group">
                              ...
                              <label class="custom-file">
                                ...
                                <img id="one" style="width='1px'; height='1px';"><img>
                              </label>
                            </div>
                        </div><!-- col-4 -->
                        <div class="col-lg-4">
                            <div class="form-group">
                              ...
                              <label class="custom-file">
                                ...
                                <span class="custom-file-control"></span>
                                <img id="two" style="width='1px'; height='1px';"><img>
                              </label>
                            </div>
                        </div><!-- col-4 -->
                        <div class="col-lg-4">
                            <div class="form-group">
                              ...
                              <label class="custom-file">
                                ...
                                <span class="custom-file-control"></span>
                                <img id="three" style="width='1px'; height='1px';"><img>
                              </label>
                            </div>
                        </div><!-- col-4 -->
                    </div><!-- row -->
...
{{-- Para obtener las subcategorias segun la categoria que he seleccionado --}}
